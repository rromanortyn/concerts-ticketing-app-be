...
## Strings
  ...
  - [6.4](#strings--eval) Never use `eval()` on a string as it opens too many vulnerabilities. eslint: [`no-eval`](https://eslint.org/docs/rules/no-eval)
...
## Semicolons
  ...
  - [21.1](#semicolons--required) **Nope.** eslint: [`semi`](https://eslint.org/docs/rules/semi)

    > Why? JavaScript does not require semicolons.
  ...
  - [21.2](#semicolons--required) **Yup.** IIFEs require a semicolon. eslint: [`semi`](https://eslint.org/docs/rules/semi)

    > Why? JavaScript requires a semicolon before IIFEs.
